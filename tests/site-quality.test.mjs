...
test("les fondations d’accessibilité restent présentes", () => {
  ...
  assert.match(source("src/app/administration/PhotoManager.tsx"), /alt: ""/);
  assert.match(source("src/app/administration/PhotoManager.tsx"), /Aucun titre accessible individuel n’est demandé/);
  assert.match(source("src/app/galerie/page.tsx"), /alt=""/);
  assert.match(source("src/app/galerie/page.tsx"), /Agrandir la photo \$\{position\} sur \$\{total\}/);
  assert.doesNotMatch(source("src/app/histoire/page.tsx"), /facebook\.com\/plugins\/video/);
  ...
  assert.match(source("src/components/layout/Footer.tsx"), /Accessibilité : totalement conforme — 100 %/);
  ...
  assert.match(source("src/components/ui/PdfViewer.tsx"), /Android/);
  assert.match(source("src/components/ui/PdfViewer.tsx"), /navigator\.maxTouchPoints > 1/);
  assert.match(source("src/components/ui/PdfViewer.tsx"), /pointer: coarse/);
