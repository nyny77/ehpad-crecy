        ...
        <AnimatePresence>
            {article && (
                ...
                >
                    ...
                    >
                        {/* Image */}
                        <div className="relative h-64 bg-gradient-to-br from-terracotta-100 to-forest-100">
                            {article.image ? (
                                <img
                                    src={article.image}
                                    alt={article.title}
                            ...
                            <button
                                onClick={onClose}
                                className="absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-charcoal-700 hover:bg-white transition-colors shadow-lg"
                            >
                            ...
                            <div className="absolute bottom-4 left-4">
                                <span className={`inline-block px-4 py-2 rounded-full text-sm font-medium ${categoryInfo.color}`}>
                                    {categoryInfo.label}
                                </span>
                            </div>
                        </div>
