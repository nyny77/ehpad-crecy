          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
              ...
              <a
                ...
                download="Livret_Accueil_EHPAD_Crecy_2026.pdf"
                className="print:hidden inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#C80040] hover:bg-terracotta-600 text-white font-semibold shadow-card hover:shadow-lg transition-all duration-300 hover:scale-105"
              >
