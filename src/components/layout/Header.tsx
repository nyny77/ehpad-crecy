            ...
            <div className="container-custom">
                <nav className="flex items-center justify-between lg:justify-center gap-2 lg:gap-4" aria-label="Navigation principale">
                    ...
                    <div className="hidden lg:flex items-center gap-0.5 xl:gap-1">
                        ...
                        <Link 
                            href="/familles"
                            className="ml-2 text-terracotta-600 hover:text-white transition-colors px-3 py-1.5 rounded-full hover:bg-terracotta-500 text-[12px] xl:text-[13px] font-medium flex items-center gap-1.5 border border-terracotta-200" 
                        >
                            💌 Familles
                        </Link>
                        ...
                        <Link 
                            href="/administration"
                            className="ml-1 text-charcoal-500 hover:text-terracotta-600 transition-colors px-3 py-1.5 rounded-full hover:bg-cream-100 dark:hover:bg-charcoal-800 text-[12px] xl:text-[13px] font-medium flex items-center gap-1.5 border border-cream-200" 
                        >
