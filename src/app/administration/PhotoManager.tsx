...
export default function PhotoManager({ initialPhotos, initialAlbums }: { initialPhotos: GalleryImage[]; initialAlbums: GalleryAlbum[] }) {
    ...
    const albumSections = useMemo(() => {
        ...
        return legacyPhotos.length ? [...dated, { id: LEGACY_ALBUM_ID, title: "Photos précédentes", date: "", createdAt: "", photos: legacyPhotos }] : dated;
    }, [albums, photos]);
